...
public class ClaseJsonGenerica<T extends Comparable<T>> {
    ...
    public HashMap<String,T> LeerValoresHashMap(String path, Object clase){
        HashMap<String,T> aCargar = new HashMap<>();
     try {
        JavaType type = mapper.getTypeFactory().constructMapLikeType(HashMap.class, String.class, HashMap.class);
        aCargar = mapper.readValue(new File(path), type);
    ...
    public TreeSet<T> LeerValoresTreeSet(String path, Object clase){
